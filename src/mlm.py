...
def mak_with_tokens(t, token_ids):
...
class MLM(nn.Module):
    def __init__(self, transformer, * , dim, num_tokens,
                 mask_prob = 0.15,
                 replace_prob = 0.9,
                 random_token_prob = 0.,
                 mask_token_id = 2,
        ...
        self.prob_token_id = pad_token_id
    ...
    def forward(self, seq, **kwargs):
        no_mask = mak_with_tokens(seq, self.mask_ignore_token_ids)
        ...
        if self.random_token_prob > 0:
            ...
            random_no_mask = mak_with_tokens(random_tokens, self.mask_ignore_token_ids)
